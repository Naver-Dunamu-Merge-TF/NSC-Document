...
<head>
    ...
    <style>
        ...
        /* 슬라이드 인 애니메이션 */
        .slide-in-center { animation: slideInCenter 0.4s ease-out forwards; }
        @keyframes slideInCenter { from { opacity: 0; } to { opacity: 1; } }
    </style>
</head>
<body>
                            ...
                            <div className="flex justify-center gap-4 my-6">
                                {[...Array(6)].map((_, i) => (
                                    <div key={i} className={`w-4 h-4 rounded-full transition-all ${
                                        i < pin.length ? 'bg-[#03C75A]' : 'bg-gray-300'
                                    }`}></div>
                                ))}
                            </div>
                                ...
                                <div className="p-4 bg-white">
                                    <button 
                                        ...
                                        className={`w-full py-4 rounded-xl font-bold text-lg text-white transition-colors ${
                                            isReady ? 'bg-[#03C75A] hover:bg-[#02b350]' : 'bg-gray-300 hover:bg-gray-400'
                                        }`}
                                    >
